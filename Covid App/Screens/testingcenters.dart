...
class _TestingCentreState extends State<TestingCentre> {
  ...
  _stateSelector(String st)
  {
    ...
    State["Andra Pradesh"] = ["Sri Venkateswara Institute of Medical Sciences,Tripati",
    ...
    State["Arunachal Pradesh"] = ["Tomo Riba Institute of Health & Medical Sciences, Naharlagun ",
      "Intermediate Reference Laboratory, Directorate of Health Sciences, Naharlagun "];


    State["Assam"] = ["Gauhati Medical College, Guwahati 57",
    ...
    State["Bihar"] = ["ICMR-Rajendra Memorial Research Institute of Medical Sciences, Patna",
    ...
    State["Chandigarh"] = ["Post Graduate Institute of Medical Education & Research, Chandigarh"
        "Govt. Medical College, Chandigarh"
        "Institute of Microbial Technology, Chandigarh"];

    State["Chhattisgarh"] = ["All India Institute of Medical Sciences, Raipur " ,
    ...
    State["Delhi"] = ["All India Institute Medical Sciences",
    ...
    State["Gujarat"] = ["BJ Medical College, Ahmedabad",
    ...
    State["Goa"] = ["#Goa Medical College, Goa ",
    ...
    State["Haryana"] = ["Pt. B.D. Sharma Post Graduate Inst. Of Med. Sciences, Rohtak",
    ...
    State["Himachal Pradesh"] = ["Indira Gandhi Medical College, Shimla",
    ...
    State["Jammu & Kashmir"] = ["Govt. Medical College, Jammu",
    ...
    State["Jharkhand"] = ["MGM Medical College & Hospital, Jamshedpur",
    ...
    State["Karnataka"] = ["Hassan Inst. of Med Science,Hasan",
    ...
    State["Kerala"] = ["National Institute of Virology, Field Unit, Allapuzzha",
    ...
    State["Maharastra"] = ["ICMR-National Institute of Virology, Pune ",
    ...
    State["Madhya Pradesh"] = ["All India Institute of Medical Sciences, Bhopal",
    ...
    State["Manipur"] = ["Jawaharlal Nehru Institute of Med. Sciences, Imphal-East, Manipur ",
      "Regional Institute of Medical Sciences, Imphal"];

    State["Meghalaya"] = ["North Eastern Indira Gandhi Regional Institute of Health & Medical Sciences, Shillong, Meghalaya ",
      "Pasteur Institute, Shillong ",
      "Civil Hospital, Tura"];

    State["Mizoram"] = ["Zoram Medical College, Falkawn ",
      "Civil Hospital, Lunglei "];

    State["Nagaland"] = ["State Referral BSL-3 Laboratory, Naga Hospital, Kohima ",
    ...
    State["Odisha"] = ["ICMR-Regional Medical Research Centre, Bhubaneshwar (High-throughput Laboratory)",
    ...
    State["Puducherry"] = ["#Jawaharlal Institute of Postgraduate Medical Education & Research, Puducherry ",
    ...
    State["Punjab"] = ["Govt. Medical College, Amritsar  ",
    ...
    State["Rajasthan"] = ["Sawai Man Singh Medical College, Jaipur ",
    ...
    State["Tamil Nadu"] = ["King Institute of Preventive Medicine & Research, Chennai ",
    ...
    State["Telangana"] = ["Gandhi Medical College, Secunderabad ",
    ...
    State["Uttar Pradesh"] = ["King George Medical University,Lucknow",
    ...
    State["Uttarkhand"] = ["Govt. Medical College, Haldwani  ",
    ...
    State["West Bengal"] = ["Institute of Post Graduate Medical Education & Research, Kolkata ",
      ...
      "Biswa Bangla Krirangan SARI/COVID Hospital, Jalpaiguri ",
    ...
    State["Andaman & Nicobar Islands"] = ["ICMR-Regional Medical Research Centre, Port Blair ",
      "A&N Islands Institute of Medical Sciences, Port Blair ",
      "GB Pant Hospital, Port Blair"];

    State["Dadra & Nagar Haveli"] = ["Shri Vinoba Bhave Civil Hospital, Silvassa "];

    State["Sikkim"] = ["Virus Research and Diagnostic Laboratory, STNM Hospital, Gangtok ",
...
print(_centre);
            ...
            Container(
              child: Column(
                children: _centre.map<Widget>((ss) => Card(
                  elevation: 0.0,
                  ...
                  child: ListTile(
                    ...
                    leading: Icon(Icons.science, color: c,),
                              trailing: Icon(Icons.location_on, color: Colors.green,),
                              title: Text(ss),
                    subtitle: Text("Click here to locate ",
                    style: TextStyle(
                      color: Colors.grey,
                    ),
                    ),
