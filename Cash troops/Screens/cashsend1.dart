import 'package:cashtroopsdemo/Screens/virat1.dart';
import 'package:flutter/material.dart';


class SendMoneyPage1 extends StatefulWidget {
  const SendMoneyPage1({ Key key }) : super(key: key);

  @override
  _SendMoneyPage1State createState() => _SendMoneyPage1State();
}
...
class _SendMoneyPage1State extends State<SendMoneyPage1> {
  ...
  Widget appBar(){
    return AppBar(
      ...
      elevation: 0,
      title: Text( "Request Cash withdrawal",
        style: TextStyle(
            color:Colors.white
        ),
      ),
...
//.0
  ...
  Widget button(){
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context) => Virat1(money) ));
      },
      child: Padding(
